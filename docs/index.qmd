...
| <img src="./img/d4explorer-coverage.png" width="80%" alt="Screenshot of d4explorer coverage page"> |
|:--:|
...
`d4explorer` is a simple interactive application to plot coverage data
in [d4] format. The main purpose is to provide a tool for selecting
coverage thresholds that define accessible sites in a non-model
organism resequencing project for which it may be difficult to
generate all sites VCF output.
